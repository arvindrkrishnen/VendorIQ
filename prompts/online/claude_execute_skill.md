# Claude Online Execution Prompt

You are executing the Universal Vendor Analysis Skill from the uploaded zip or connected GitHub repository.
...
1. Use the repository as the VendorIQ instruction package.
2. Read:
   - `README.md`
   - `SKILL.md`
   - `skills.md`
...
3. Use long-context synthesis to execute each agent section.
4. Preserve citations and source evidence.
5. Return one final self-contained interactive HTML artifact.
...
- Use long-context reasoning to maintain consistency across products, competitors, references, and Quality Document JSON.
- Do not summarize away product-by-product architecture, product moat, or competitive due-diligence details.
- Keep large tables readable in HTML with horizontal scrolling when necessary.
