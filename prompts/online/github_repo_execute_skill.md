# GitHub Repository Execution Prompt

Use this GitHub repository as the skill package:
...
1. Treat the repository as the VendorIQ instruction package.
2. Read:
   - `README.md`
   - `SKILL.md`
   - `skills.md`
...
3. Use browsing/search/grounding if available.
4. Execute the full VendorIQ workflow and return one final self-contained interactive HTML artifact.
